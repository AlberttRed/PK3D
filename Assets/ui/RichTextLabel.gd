...
func _ready():
	$Outline.text = text
	set("custom_fonts/normal_font", text_font)
	$Outline.set("custom_fonts/normal_font", text_font)
	get("custom_fonts/normal_font").set_size(font_size)
	$Outline.get("custom_fonts/normal_font").set_size(font_size)
