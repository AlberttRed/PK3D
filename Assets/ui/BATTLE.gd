...
const BATTLEC = preload("res://Assets/ui/battle/BATTLE_Constants.gd")
...
#		animation.track_set_path(0, "playerBase/" + active_pokemon.node.name + ":position")
...
#		animation.add_track(Animation.TYPE_VALUE)
#		animation.track_set_path(1, "" + active_pokemon.hp_bar.name + ":position")
...
##				animation.add_track(Animation.TYPE_VALUE)
##				animation.track_set_path(0, "" + base.name + "/" + p.node.name + ":position") #pkmn_player
...
##
##				animation.add_track(Animation.TYPE_VALUE)
##				animation.track_set_path(1, ""+ base.name + "/" + p.node.name + ":rotation_degrees")
...
##
##				animation.add_track(Animation.TYPE_VALUE)
##				animation.track_set_path(5, ""+ base.name + "/" + p.node.name + ":centered")
##				animation.track_insert_key(5, 0.0, true)
##				animation.track_insert_key(5, 1.0, false)
##
##				animation.add_track(Animation.TYPE_VALUE)
##				animation.track_set_path(6, "" + p.hp_bar.name + ":position")
...
#
#				animation.add_track(Animation.TYPE_VALUE)
#				animation.track_set_path(0, "" + base.name + "/" + p.pokeball_node.name + ":texture") #pkmn_player
#				animation.track_insert_key(0, 0.0, load("res://ui/Pictures/ball00_open.png"))
#
#				animation.add_track(Animation.TYPE_VALUE)
#				animation.track_set_path(1, "" + base.name + "/" + p.node.name + ":scale") #pkmn_player
#				animation.track_insert_key(1, 0.0, Vector2(0.00001,0.00001))
#				animation.track_insert_key(1, 0.6, Vector2(1,1))
#
#				animation.add_track(Animation.TYPE_VALUE)
#				animation.track_set_path(2, "" + base.name + "/" + p.node.name + ":visible") #pkmn_player
...
#
#				animation.add_track(Animation.TYPE_VALUE)
#				animation.track_set_path(4, "" + base.name + "/" + p.node.name + ":position") #pkmn_player
##				animation.track_insert_key(0, 0.0, CONST.BATTLE.BACK_BALL_POS)
##				animation.track_insert_key(0, 0.4, final_position + Vector2(59.8,-24))
##				animation.track_insert_key(0, 0.7, final_position + Vector2(85.6,16))
##				animation.track_insert_key(0, 0.9, final_position + Vector2(108,160))
...
#
#				animation.add_track(Animation.TYPE_VALUE)
#				animation.track_set_path(5, "" + base.name + "/" + p.pokeball_node.name + ":visible")
#				animation.track_insert_key(5, 0.0, true)
...
#
#				animation.add_track(Animation.TYPE_VALUE)
#				animation.track_set_path(7, ""+ base.name + "/" + p.node.name + ":texture")
#				animation.track_insert_key(7, 0.0, load("res://Sprites/Battlers/" + str(p.pkm_id).pad_zeros(3) + ".png"))
#
##				animation.add_track(Animation.TYPE_VALUE)
##				animation.track_set_path(8, "" + base.name + "/" + p.node.name + ":material")
...
#
#	#			animation.add_track(Animation.TYPE_VALUE)
#	#			animation.track_set_path(1, "playerBase/pkmn_player:texture")
